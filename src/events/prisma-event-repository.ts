  ...
  public async create(input: CreateChurchEvent): Promise<ChurchEvent> {
    ...
    const event = await this.prisma.event.create({
      data: {
        ...
        imageFileUniqueId: input.imageFileUniqueId ?? null,
...
function toDomain(event: PrismaEvent, chatId: string): ChurchEvent {
  return {
    ...
    ...(event.imageFileId === null ? {} : { imageFileId: event.imageFileId }),
    ...(event.imageFileUniqueId === null ? {} : { imageFileUniqueId: event.imageFileUniqueId }),
