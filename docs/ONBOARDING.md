...
6. Upload audio under 20 MB or use `/sermon_link HTTPS_URL` for a larger file. Track it with `/sermon_status ID`, inspect generated drafts with `/sermons`, and approve one with `/sermon_approve ID`.
